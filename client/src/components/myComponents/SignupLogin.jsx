...
const SignupLogin = () => {
  ...
  return (
    <>
        <div className="container p-2 flex w-full items-center justify-center">
            <div className="left border-2 border-black">
            ...
            <div className="right border-2 border-black">
            <Tabs>
                <TabList>
                    <Tab>Login</Tab>
                    <Tab>Register</Tab>
                ...
                <TabPanels>
                    <TabPanel>
                        <>
                            ...
                            <Button colorScheme='teal' size='xs' onClick={()=>{dispatch(incrementRegisterStage())}}>
                                Create Account
                            </Button>
                            </div>
                        </>
