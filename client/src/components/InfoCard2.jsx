            ...
            <div className='flex w-1/2 justify-start'>
                ...
                <div className='mx-4'>
                    ...
                    <p className='text-sm text-slate-500'>
                        Expiry: {item.expiry?item.expiry:'expiry'}
                    </p>
                </div>
            </div>
            <div className='flex w-1/2 items-center justify-around'>
                <div className='text-lg font-semibold text-slate-800'>{item.position?item.position:"Position"}</div>
                <div className='flex items-center justify-center bg-violet-400 rounded-full h-[2.5rem] w-[2.5rem]'>
                    <div className='text-white text-center'>{item.availableCount?item.availableCount:"C"}</div>
                </div>
